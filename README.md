...
BlaBla is location-based social media service. This release intends to share a simplified version of Expo apps and Microservice architecture. This repository contains microservice for Chat in post with Nest.JS and Socket.io. Also, MySQL is used for database and Prisma is used for ORM
...
**Note:** This document is about the microservices using **Nest.JS and Socket.io**.
